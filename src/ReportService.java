...
public class ReportService {
    ...
    // Print full inventory report to console
    ...
    // Print category-wise stock summary
    ...
    // Export to CSV and return file path
    public String exportToCSV(String reportDir) {
        return CSVExporter.exportReport(products, reportDir);
    }
